...
# with open('test.pickle', 'rb') as inPickle: #loading the stored classifier from pickle
#     out = cPickle.load(inPickle)
...
# 	pickle.dump(out, file)
 ...
 #    cPickle.dump(clf_randomforest, fid) 

## Opening the saved model parameter
# pickle_in = open(PICKLE_FILE, 'rb')
# out = cPickle.load(pickle_in)
